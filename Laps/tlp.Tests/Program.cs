...
Assert(firstHeat.LaneRacers[2] == "R1", "first heat should assign second racer to green");
Assert(firstHeat.LaneRacers[4] == "R2", "first heat should assign third racer to blue");
Assert(firstHeat.LaneRacers[6] == "R3", "first heat should assign fourth racer to purple");
Assert(firstHeat.LaneRacers[7] == "R4", "first heat should assign fifth racer to black");
Assert(firstHeat.LaneRacers[5] == "R5", "first heat should assign sixth racer to yellow");
Assert(firstHeat.LaneRacers[3] == "R6", "first heat should assign seventh racer to orange");
Assert(firstHeat.LaneRacers[1] == "R7", "first heat should assign eighth racer to white");
...
Assert(secondHeat.LaneRacers[4] == "R1", "green racer should rotate to blue");
Assert(secondHeat.LaneRacers[6] == "R2", "blue racer should rotate to purple");
Assert(secondHeat.LaneRacers[7] == "R3", "purple racer should rotate to black");
Assert(secondHeat.LaneRacers[5] == "R4", "black racer should rotate to yellow");
Assert(secondHeat.LaneRacers[3] == "R5", "yellow racer should rotate to orange");
Assert(secondHeat.LaneRacers[1] == "R6", "orange racer should rotate to white");
